...
const Customers = () => {
  ...
  return (
    <div dir='rtl' className='container text-center'>
      ...
      <p className='mx-auto'>לקוחות יקרים, זוהי הפינה שלכם <br /> מוזמנים לכתוב תגובות עלינו, המלצות על המקום ועל האוכל <br /> שילובי מנות שאהבתם, וככל העולה על רוחכם. <br />נשמח לשמוע ממכם על מנת שנדע לשמר ולהשתפר.</p>
